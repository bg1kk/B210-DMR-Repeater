...
源码与Pi5部署版本：`V1.2.1 B176`。该版本重排800x480校准页面，顶部输入、SNR、硬件/软件AGC和增益信息使用固定列，校准表扩展至页面安全底边并采用18px行高，确保高档11行、`-125 dBm`、RX1/RX2表头、测量值和“待测”完整显示。运行事件继续在启动时显示活动转发频道，并为所有“等待确认”操作提供终态结果。
